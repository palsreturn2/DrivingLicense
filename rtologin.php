...
if(isset($_POST['submit'])) 
{
	...
	if ($upass == $mdpass and $row['ROLE']=='rto') 
	{
		$_SESSION['rto'] = $row['EMAIL'];
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Driving License</strong> Regional Training Office Login</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>RTO Login</h3>
                            		<p>Enter your RTO username and password to log on:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="POST" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="username" placeholder="Username..." class="form-username form-control" id="form-email">
			                        </div>
			                        <div class="form-group">
